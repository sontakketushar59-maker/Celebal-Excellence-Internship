...
-- 1️⃣ Orders above average sales
-- Meaning: High-value orders
SELECT *
FROM orders
WHERE Sales > (SELECT AVG(Sales) FROM orders);

-- 2️⃣ Highest sales order per customer
...
-- 3️⃣ Total sales per customer (CTE)
...
-- 4️⃣ Customers above average sales (CTE + Subquery)
...
-- 5️⃣ Rank customers by sales (Window Function)
...
-- 6️⃣ Row numbers per order within customer
